...
Program::Program(int argc, char** argv) {
  ...
  userpath = {nall::configpath(), "xSnes/"};
  sharedpath = {nall::sharedpath(), "xSnes/"};
...
int main(int argc, char** argv) {
  ...
  Application::Cocoa::onAbout = [&] {
    ...
    .setText({
      ...
      "Derived from ", Emulator::OriginalName, " v", Emulator::FromVersion, "\n",
      "Profile: ", Emulator::Profile, "\n",
      "higan/bsnes Developer: ", Emulator::Developer, "\n",
      "xSnes Maintainer: ", Emulator::Maintainer, "\n",
