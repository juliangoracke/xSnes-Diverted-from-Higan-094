...
LibraryImport::LibraryImport() {
  setMargin(5);
  information.setText({
    "xSnes, like higan, manages games in a library. To play a game, you must first import the game.\n"
...
LibraryManager::LibraryManager() {
  ...
  //initial config value of -1 defaults to import tab on first launch of xSnes
